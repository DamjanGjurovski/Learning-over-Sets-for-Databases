...
def check_network_estimates(predicted_cardinality, true_cardinality, statistics_file_name, print_time, encoding_avg_time = 0, avg_time_prediction_ms = 0, store_file_name = "name", nb_outliers = 0, path = ""):
    correct_estimates = 0
    wrong_estimates = 0
    max_correct = 0
    ...
    with open('edbt_statistics_as_files/' + path + statistics_file_name,'w') as store_file:
    ...
    create_csv_statistics_file(final_print_statistics, statistics_file_name, print_time, path)


def create_csv_statistics_file(data,file_name,print_time, path):
    path_to_file = 'edbt_statistics/' + path + file_name + '.txt'
    with open(path_to_file, 'w') as filehandle:
        filehandle.write(data)
        filehandle.write(str(print_time))
    print('file crated')